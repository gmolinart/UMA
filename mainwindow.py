...
class Ui_ModelRenamer(object):
    def setupUi(self, ModelRenamer):
        ...
        self.gridLayout_3.addWidget(self.pushButton, 8, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.additional_lb, 5, 0, 1, 1)
        self.preview_lb = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.preview_lb.setObjectName("preview_lb")
        self.gridLayout_3.addWidget(self.preview_lb, 7, 1, 1, 1)
